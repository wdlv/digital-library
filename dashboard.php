    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="col-lg-3"><input type="text" class="form-control" id="bname" placeholder="Book/Article Name"></div>
          <div class="col-lg-2"><input type="text" class="form-control" id="fname" placeholder="Author First Name"></div>
          <div class="col-lg-2"><input type="text" class="form-control" id="lname" placeholder="Author Last Name"></div>
          <div class="col-lg-3"><input type="text" class="form-control" id="pyear" placeholder="Published Year"></div>
          <div class="col-lg-2"><button class="btn btn-lg btn-primary btn-block" id="subsearch" type="submit">Search</button></div>
