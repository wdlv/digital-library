      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="add.php">Add Record</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		 ...
		 <form class="form-signin">   
		  ...
		  <div class="col-8">
		    <input class="form-control" type="text" placeholder="Book Name" id="bname_input">
		  </div>
		</div>
		<div class="form-group row">
		  <label for="example-text-input" class="col-2 col-form-label">Author First Name</label>
		  <div class="col-8">
		    <input class="form-control" type="text" placeholder="First Name" id="fname_input">
		  </div>
		</div>
		<div class="form-group row">
		  <label for="example-text-input" class="col-2 col-form-label">Author Last Name</label>
		  <div class="col-8">
		    <input class="form-control" type="text" placeholder="Last Name" id="lname_input">
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-8">
		    <input class="form-control" type="text" placeholder="Published Year" id="pubyear_input">
		  </div>
		</div>
		<div class="form-group row">
		  <label for="example-number-input" class="col-2 col-form-label">Rating</label>
		  <div class="col-8">
		    <input class="form-control" type="text" placeholder="Rating" id="rating_input">
		  </div>
		</div>
		<button class="btn btn-lg btn-primary btn-block" id="btnAdd" type="submit">Add Record</button>
		</form>
